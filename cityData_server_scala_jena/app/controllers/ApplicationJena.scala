...
object ApplicationJena extends AbstractApplication[Jena, Dataset] with REST_SPARQL_bridge_Jena 

//object ApplicationJena1 extends Controller with REST_SPARQL_bridge_Jena {
//
//  /**
